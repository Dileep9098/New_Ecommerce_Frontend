...
export default function EditUserDetails() {
    ...
    useEffect(() => {
        ...
        async function fetchUserDetails() {
            try {
                const response = await axiosInstance.get(`${Config.END_POINT_LIST["GET_ADMIN_USER_DETAILS"]}/${param.id}`, { withCredentials: true });
        ...
        if (selectedCountry && PostalCode) {
            const fetchData = async () => {
                try {
                    ...
                    // const getUserDetails= axiosInstance.get(`${Config.END_POINT_LIST["GET_ADMIN_USER_DETAILS"]}/${param.id}`, { withCredentials: true })
                    // console.log("getUserDetaisl:", getUserDetails);
    ...
    }, [selectedCountry, PostalCode, param]);
    ...
    console.log("USer ki info", userInfo)
    ...
    useEffect(() => {
        if (userInfo) {
            ...
            setAddressLineOne(userInfo.address || "")
            ...
            setStateByPincode(userInfo.StateName || "")
            setCountryName(userInfo.CountryName || "")
            setDOB(userInfo.DOB || "")
            ...
            setAddressLineOne(userInfo.address || "")
            setAddressLineOne1(userInfo.address || "")
            setPostalCode(userInfo.PostalCode || "")
    ...
    const handleSubmit = async (e) => {
        ...
        // Basic Form Data Logging (Optional)
        console.log(`
            name : ${name} 
            lname : ${lname} 
            email : ${email} 
        ...
        try {
            ...
            const response = await axiosInstance.put(`${Config.END_POINT_LIST["UPDATE_ADMIN_USER_DEATAILS"]}/${param.id}`, myform, { withCredentials: true });
            ...
            // Handle specific error like duplicate email
            ...
            console.error(error.response ? error.response.data.message : 'An unexpected error occurred');
        }
    };
                                                ...
                                                <div className="row">
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <input type="text" className="form-control" id="userName" name="name" onChange={(e) => setName(e.target.value)} value={name} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-12">
                                                    ...
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <input type="text" className="form-control" id="shortDescription" name="lname" onChange={(e) => setLastName(e.target.value)} value={lname} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <input type="text" className="form-control" id="shortDescription" name="email" onChange={(e) => setEmailAddress(e.target.value)} value={email} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <select className="form-select" id="example-select" name='userType' onChange={(e) => setUserType(e.target.value)} value={userType}>
                                                    ...
                                                    <div className="col-12 ">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <select className="form-select" id="example-select" name='role' onChange={(e) => setRole(e.target.value)} value={role}>
                                                    ...
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <input type="number" className="form-control" id="userName" name="phone" onChange={(e) => setPhone(e.target.value)} value={phone} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <input type="number" className="form-control" id="userName" name="mobileNo" onChange={(e) => setMobileNo(e.target.value)} value={mobileNo} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <div className=" position-relative" id="datepicker2">
                                                                    <input type="date" className="form-control" name='DOB' onChange={(e) => setDOB(e.target.value)} value={DOB} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <select className="form-select" id="example-select" name='gander' onChange={(e) => setGender(e.target.value)} value={gender}>
                                                    ...
                                                    {/* <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <input type="text" className="form-control" id="shortDescription" name="password" onChange={(e) => setPassword(e.target.value)} value={password}/>
                                                            </div>
                                                        </div>
                                                    </div> */}
                                                    {/* <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <input type="text" className="form-control" id="shortDescription" name="cpassword" onChange={(e) => setCPassword(e.target.value)} value={cpassword} />
                                                            </div>
                                                        </div>
                                                    </div> */}
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <div className="form-check form-checkbox-info mb-2 fs-3">
                                                                    <input type="checkbox" className="form-check-input" id="customCheckcolor3" name='IsActive' onChange={(e) => setIsActive(e.target.value)} checked={IsActive} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <div className="form-check form-checkbox-info mb-2 fs-3">
                                                                    <input type="checkbox" className="form-check-input" id="customCheckcolor3" name='IsVerified' onChange={(e) => setIsVerified(e.target.value)} checked={IsVerified} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <input type="text" className="form-control" id="userName" name="PostalCode" onChange={(e) => setPostalCode(e.target.value)} value={PostalCode} />
                                                    ...
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <input type="text" className="form-control" id="userName" name="address" onChange={(e) => setAddressLineOne(e.target.value)} value={address} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-12">
                                                        <div className="row mb-3">
                                                            ...
                                                            <div className="col-md-9">
                                                                <input type="text" className="form-control" id="userName" name="address1" onChange={(e) => setAddressLineOne1(e.target.value)} value={address1} />
                                                            </div>
                                                        </div>
                                                    </div>
