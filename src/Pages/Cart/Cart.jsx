                                                                                        ...
                                                                                        <div ref={popoverRef} className="popover popover2">
                                                                                            ...
                                                                                            <div className="popover-body">
                                                                                                <ul className="share-options">
                                                                                                    <li>
                                                                                                        <a className="share-option email" href="mailto:care@mobiteqpay.com" onClick={() => togglePopover(item.ProductId)}>
                                                                                                            <span className="material-symbols-outlined text-dark me-2">mail</span>
                                                                                                            <span className="label">Email</span>
                                                                                                        </a>
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <a className="share-option pinterest" href="#/" onClick={() => togglePopover(item.ProductId)}>
                                                                                                             <i class="bi bi-pinterest me-2 fs-4 text-red-500"></i>
                                                                                                            <span className="label">Pinterest</span>
                                                                                                        </a>
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <a className="share-option facebook" href="#" onClick={() => togglePopover(item.ProductId)}>
                                                                                                            <i class="bi bi-facebook me-2 fs-4 text-blue-500"></i>
                                                                                                            <span className="label">Facebook</span>
                                                                                                        </a>
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <a className="share-option twitter" href="#" onClick={() => togglePopover(item.ProductId)}>
